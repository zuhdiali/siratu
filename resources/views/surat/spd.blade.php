...
<div class="container">
  <div class="page-inner">
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4" >
      <div>
        <h3 class="fw-bold mb-3">SPD</h3>
        <h6 class="op-7 mb-2">Daftar spd </h6>
      </div>
      <div class="ms-md-auto py-2 py-md-0">
        <a href="{{url('surat/create/spd')}}" class="btn btn-primary btn-round">Tambah surat</a>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Daftar Riwayat Nomor SPD</h4>
          </div>
          <div class="card-body">
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th>Nomor SPD</th>
                    <th>Kegiatan</th>
                    <th>Pegawai Yang Berkegiatan</th>
                    <th>Tanggal Kegiatan Dimulai</th>
                ...
                <tbody>
                  @foreach($surats as $surat)
                    ...
                    <tr>
                      ...
                      <td>{{\Carbon\Carbon::parse($surat->tgl_awal_kegiatan)->translatedFormat('d F Y')}}</td>
                      <td>{{\Carbon\Carbon::parse($surat->tgl_akhir_kegiatan)->translatedFormat('d F Y')}}</td>
