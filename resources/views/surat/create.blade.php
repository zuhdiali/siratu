                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <h5>
                                        ...
                                        <span id="no-surat">{{str_pad($noTerakhir+1,4,"0",STR_PAD_LEFT);}}</span>/<span id="kode-tim">{{old('tim')}}</span>/<span id="kode-surat">{{old('kode')}}</span>/<span>{{date('m')}}</span>/<span>{{date('Y')}}</span>
                                        </span>
                                    </h5>
