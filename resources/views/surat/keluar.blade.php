  ...
  <div class="page-inner">
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4" >
      <div>
        ...
        <h6 class="op-7 mb-2">Daftar surat keluar </h6>
      </div>
      <div class="ms-md-auto py-2 py-md-0">
        <a href="{{url('surat/create/keluar')}}" class="btn btn-primary btn-round">Tambah surat</a>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Daftar Riwayat Nomor Surat Keluar</h4>
          </div>
          <div class="card-body">
