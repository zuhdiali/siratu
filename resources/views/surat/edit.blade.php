...
<div class="container">
    <div class="page-inner">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form action="{{url('surat/update/'.$surat->jenis_surat."/".$surat->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf <!-- {{ csrf_field() }} -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group  {{$errors->has('kode') ? 'has-error has-feedback' : ''}}">
                                        ...
                                        >
                                          <option value="">(Pilih salah satu)</option>
                                          @foreach($opsiSuratAwal as $opsi)
                                          <option value="{{$opsi->kode_surat_gabungan}}" {{$surat->kode_surat == $opsi->kode_surat_gabungan ? 'selected' : ''}}>{{$opsi->kode_surat_gabungan}} - {{$opsi->klasifikasi}}</option>
                                          @endforeach
                                        </select>
                                        @if ($errors->has('kode'))
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{$errors->has('file') ? 'has-error has-feedback' : ''}}">
                                        ...
                                        @else
                                        <small  class="form-text text-muted">Kosongkan jika tidak ingin mengganti foto surat</small>
                                        @endif
                                      </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group {{$errors->has('tgl_akhir_kegiatan') ? 'has-error has-feedback' : ''}}">
                                        <label for="tgl_akhir_kegiatan">Tanggal Kegiatan Dimulai</label>
                                        <input
                                          type="date"
                                          class="form-control"
                                          id="tgl_akhir_kegiatan"
                                          name="tgl_akhir_kegiatan"
                                          value="{{ $surat->tgl_akhir_kegiatan }}"
                                        />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group {{$errors->has('pegawai_yang_bertugas') ? 'has-error has-feedback' : ''}}">
                                        ...
                                        @foreach($pegawais as $p)
                                            <option value="{{$p->id}}" {{$surat->pegawai_yang_bertugas == $p->id ? 'selected' : ''}}>{{$p->nama}}</option>
                                        @endforeach
                                        </select>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <h5>
                                        ...
                                        {{-- @if($jenis != 'spd')B-@endif --}}
                                        <span id="no-surat">{{$pecahanSurat[0]}}</span>/<span id="kode-tim">{{$pecahanSurat[1]}}</span>/<span id="kode-surat">{{$pecahanSurat[2]}}</span>/<span>{{$pecahanSurat[3]}}</span>/<span>{{$pecahanSurat[4]}}</span>
                                        </span>
                                    </h5>
...
<script>
    ...
    var opsiTeknis = '<option value="">(Pilih salah satu)</option><option value="VS.200">VS.200 - Survei - PELATIHAN/UJICOBA</option><option value="VS.210">VS.210 - Survei - Pelatihan Instruktur</option><option value="VS.220">VS.220 - Survei - Pelatihan Petugas</option><option value="VS.230">VS.230 - Survei - Pelatihan Petugas Pengolahan</option><option value="VS.240">VS.240 - Survei - Perancangan Tabel</option><option value="VS.300">VS.300 - Survei - PELAKSANAAN LAPANGAN</option><option value="VS.310">VS.310 - Survei - Listing</option><option value="VS.320">VS.320 - Survei - Pemilihan Sampel</option><option value="VS.330">VS.330 - Survei - Pengumpulan Data</option><option value="VS.340">VS.340 - Survei - Pemeriksaan Data</option><option value="VS.350">VS.350 - Survei - Pengawasan Lapangan</option><option value="VS.360">VS.360 - Survei - Monitoring Kualitas</option><option value="SS.200">SS.200 - Sensus - PELATIHAN/UJICOBA</option><option value="SS.210">SS.210 - Sensus - Pelatihan Instruktur</option><option value="SS.220">SS.220 - Sensus - Pelatihan Petugas</option><option value="SS.230">SS.230 - Sensus - Pelatihan Petugas Pengolahan</option><option value="SS.240">SS.240 - Sensus - Perancangan Tabel</option><option value="SS.300">SS.300 - Sensus - PELAKSANAAN LAPANGAN</option><option value="SS.310">SS.310 - Sensus - Listing</option><option value="SS.320">SS.320 - Sensus - Pemilihan Sampel</option><option value="SS.330">SS.330 - Sensus - Pengumpulan Data</option><option value="SS.340">SS.340 - Sensus - Pemeriksaan Data</option><option value="SS.350">SS.350 - Sensus - Pengawasan Lapangan</option><option value="SS.360">SS.360 - Sensus - Monitoring Kualitas</option>';
