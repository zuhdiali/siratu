                ...
                <div class="card">
                    <form action="{{url('pembayaran/store/'. $jenis)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="card">
                                        <div class="card-header">
                                        <h4 class="card-title">@if($jenis == 'mitra')Mitra @else Pegawai @endif Yang Belum Dibayarkan</h4>
                                        </div>
                                        <div class="card-body">
                                        <div class="table-responsive">
                                            ...
                                            <thead>
                                                <tr>
                                                <th>Nama @if($jenis == 'mitra')Mitra @else Pegawai @endif</th>
                                                <th>Honor</th>
                                                </tr>
                                            </thead>
                        ...
                        <div class="card-action">
                            <input type="hidden" name="tipe_pembayaran" value="{{$jenis}}" />
